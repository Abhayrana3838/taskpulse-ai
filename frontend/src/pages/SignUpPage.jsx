...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message === 'Network Error' || !err.response) {
        ...
        errorMessage = err.response?.data?.detail || 'Invalid data. Please check your inputs.';
  ...
  const features = [
    { icon: '🚀', title: 'Lightning Fast', desc: 'Built for speed and efficiency' },
    { icon: '🎯', title: 'Laser Focused', desc: 'Keep your team aligned' },
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-900/20 to-purple-900/20 p-12 flex-col justify-center">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-12">
            Join thousands of teams who trust TaskPulse AI for their project management needs.
          </p>
          ...
          <GlassCard className="p-8">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white hover:bg-gray-700 transition-colors"
                >
